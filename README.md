...
![Bedrock](https://img.shields.io/badge/AWS_Bedrock-232F3E?style=for-the-badge&logo=amazonwebservices&logoColor=white)
![LangChain](https://img.shields.io/badge/LangChain-1C3C3C?style=for-the-badge&logo=langchain&logoColor=white)
![MCP](https://img.shields.io/badge/MCP-000000?style=for-the-badge&logo=anthropic&logoColor=white)

`RAG` · `Agentic workflows` · `Tool use / function calling` · `VLM document extraction` · `Prompt & context engineering` · `Multi-model fallback chains`
...
![Step Functions](https://img.shields.io/badge/Step_Functions-FF4F8B?style=for-the-badge&logo=awslambda&logoColor=white)
...
![My Skills](https://skillicons.dev/icons?i=pycharm,vscode,git,github,gitlab,postman,bash&theme=dark)

---

### 🚀 Projects

**[Bringer](https://bringer.tech)** — live SaaS for restaurant digital menus. Full stack: FastAPI backend, PostgreSQL, S3-backed media, multi-tenant, Hebrew/Arabic/English.
